...
Five parts so far: where a tensor sits, the size of a step, the path a derivative
takes, what the product does once layers stack, and the price of cutting the data
up. Five times over, something invisible measured and drawn.
