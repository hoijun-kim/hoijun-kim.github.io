...
```
        해석적                   수치적                  일치
dL/dw   -0.26526985862215685   -0.26526985864860908   소수점 10자리
dL/db   -0.13263492931107843   -0.13263492926879339   소수점 9자리
```

`dL/dw` 는 열 자리, `dL/db` 는 아홉 자리에서 갈린다. 같은 방법으로 잰 두 값이
