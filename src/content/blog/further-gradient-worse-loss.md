...
1편에서 쓴 다섯 구조를 각자의 최저점까지 학습시키고 재면
...
1편에서 커널 5짜리 4층이라 수용장이 `4 x 4 + 1 = 17` 자라고 적었다. 그 말은 17
자보다 먼 자리는 계산 그래프에 아예 안 들어간다는 뜻이고, 안 들어가면 기울기가
작은 게 아니라 없다. 1편의 문장이 여기서 정확히 확인된다.
...
1편에서 이미 같은 모양을 봤다. 트랜스포머는 GRU 보다 4만 배 멀리 기울기를
